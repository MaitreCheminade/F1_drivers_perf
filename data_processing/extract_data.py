...
default_drivers_list = ["HAM", "VER", "BOT", "LEC", "ALO", "TSU", "RIC", "GAS", "OCO", "PER", "SAI", "NOR", "RUS",
                        "HUL", "MAG", "MAZ", "MSC", "GRO", "VET", "RAI", "VAN", "STR",  "ERI", "HAR",  "SIR", "ALB",
                        "GIO", "KVY"]
start_year = 2019
finish_year = 2023
...
def get_drivers_race_pace(race_number: int, year):
    ...
    if not driver_laps.empty:
        ...
        driver_laps.drop(["Time", "index", "LapNumber", "PitOutTime", "PitInTime", "Sector1Time", "Sector2Time",
                                    "Sector3Time", "Sector1SessionTime", "Sector2SessionTime", "Sector3SessionTime",
                                    "SpeedI1", "SpeedI2", "SpeedFL", "SpeedST", "LapStartTime", "LapStartDate",
                                    "DeletedReason", "Deleted", "FastF1Generated", "IsAccurate"], axis=1, inplace=True)
...
def get_drivers_race_information(drivers_list, year_list):
    ...
    for year in year_list:
        ...
        year_results.to_csv(f"../tmp/years/{year}.csv", sep=";", header=True, encoding="UTF-8")
