...
st.markdown("---")
st.markdown("Hello ! Select a race on the left side menu and choose the drivers to compare. The plots will show the distribution of their laptimes during the race.")
