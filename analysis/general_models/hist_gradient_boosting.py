...
# créer le modèle
n_trees = 200
gradient_model = HistGradientBoostingRegressor(**params)
gradient_model.fit(x_train, y_train)

y_train_predict = gradient_model.predict(x_train)
y_test_predict = gradient_model.predict(x_test)
...
feature_importances = gradient_model.score()
